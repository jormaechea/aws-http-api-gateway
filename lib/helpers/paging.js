...
const isValidPageNumber = pageNumber => Number.isInteger(pageNumber) && pageNumber >= 1;

const isValidPageSize = (pageSize, maxPageSize) => pageSize === undefined || pageSize === null
	|| (Number.isInteger(pageSize) && pageSize <= maxPageSize);
...
module.exports = class Sort {
	...
	parseRequestSortParams(pageNumber, pageSize) {
