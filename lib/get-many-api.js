...
module.exports = class GetManyApi extends Api {
	...
	async process() {
		...
		if(!fetcher.get || typeof fetcher.get !== 'function')
			throw new ConfigurationError('Fetcher must have a get method. Review the documentation');
		...
		let records = await fetcher.get(fetchParams);
